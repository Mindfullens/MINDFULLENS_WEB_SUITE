...
local EFFECTS = {
    ...
    photon_scattering = {
        ...
        cine = {
            { key = "Highlights2012", delta = -19, min = -100, max = 100 },
        ...
        diffuse = {
            { key = "Highlights2012", delta = -26, min = -100, max = 100 },
            { key = "Whites2012", delta = -19, min = -100, max = 100 },
    ...
    mackie_lines = {
        ...
        luminous = {
            ...
            { key = "Highlights2012", delta = 10, min = -100, max = 100 },
            { key = "Contrast2012", delta = 8, min = -100, max = 100 },
            { key = "Clarity2012", delta = 17, min = -100, max = 100 },
        ...
        etched = {
            ...
            { key = "Texture", delta = 17, min = -100, max = 100 },
            { key = "Blacks2012", delta = -4, min = -100, max = 100 },
        },
    },
    grain_rms = {
    ...
    grain_clumping = {
        ...
        broken = {
            { key = "GrainAmount", delta = 13, min = 8, max = 100 },
            { key = "GrainFrequency", delta = 23, min = 18, max = 100 },
            { key = "Texture", delta = 10, min = -100, max = 100 },
            { key = "Clarity2012", delta = 4, min = -100, max = 100 },
        },
    },
    ...
    grain_lr_roughness = {
        ...
        coarse = {
            { key = "GrainFrequency", delta = 12, min = 18, max = 100 },
        },
    },
    surface_roughness = {
        polished = {
    ...
    anti_halation_bloom = {
        ...
        bleeding = {
            ...
            { key = "Whites2012", delta = -24, min = -100, max = 100 },
            { key = "Dehaze", delta = -12, min = -50, max = 50 },
    ...
    optical_bloom = {
        ...
        cine = {
            ...
            { key = "Texture", delta = -12, min = -100, max = 100 },
            { key = "Dehaze", delta = -10, min = -50, max = 50 },
            { key = "Highlights2012", delta = -15, min = -100, max = 100 },
            { key = "Whites2012", delta = -9, min = -100, max = 100 },
        ...
        halated = {
            ...
            { key = "Texture", delta = -16, min = -100, max = 100 },
            { key = "Dehaze", delta = -12, min = -50, max = 50 },
            { key = "Highlights2012", delta = -20, min = -100, max = 100 },
            { key = "Whites2012", delta = -11, min = -100, max = 100 },
    ...
    film_damage = {
        ...
        distressed = {
            { key = "Blacks2012", delta = 14, min = -100, max = 100 },
            { key = "Contrast2012", delta = -12, min = -100, max = 100 },
            { key = "Highlights2012", delta = -17, min = -100, max = 100 },
            { key = "Whites2012", delta = -12, min = -100, max = 100 },
            { key = "Clarity2012", delta = -8, min = -100, max = 100 },
            { key = "Dehaze", delta = -8, min = -50, max = 50 },
            { key = "Temperature", delta = 220, min = 2000, max = 50000, skipIfGrayscale = true },
