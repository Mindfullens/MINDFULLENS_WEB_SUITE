...
local EFFECTS = {
    ...
    hd_curve = {
        ...
        cinematic = {
            { key = "Contrast2012", delta = 9, min = -100, max = 100 },
            { key = "Shadows2012", delta = -9, min = -100, max = 100 },
            { key = "Blacks2012", delta = -8, min = -100, max = 100 },
            { key = "Highlights2012", delta = -7, min = -100, max = 100 },
            { key = "Whites2012", delta = -4, min = -100, max = 100 },
        },
    },
    mtf_response = {
        ...
        etched = {
            ...
            { key = "Texture", delta = 18, min = -100, max = 100 },
            { key = "Dehaze", delta = 8, min = -50, max = 50 },
        },
    },
    ...
    reciprocity_tail = {
        ...
        prolonged = {
            { key = "Shadows2012", delta = 8, min = -100, max = 100 },
            { key = "Blacks2012", delta = 7, min = -100, max = 100 },
            { key = "Contrast2012", delta = -5, min = -100, max = 100 },
        ...
        extreme = {
            { key = "Shadows2012", delta = 11, min = -100, max = 100 },
