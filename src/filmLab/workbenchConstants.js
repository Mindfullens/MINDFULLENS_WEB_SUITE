...
export const SLIDER_DEFS = {
  ...
  brushMaskExposure: { label: 'Ekspozycja lokalna', min: -100, max: 100 },
  ...
  depthMaskMin: { label: 'Głębia proxy — min', min: 0, max: 100 },
  depthMaskMax: { label: 'Głębia proxy — max', min: 0, max: 100 },
  depthMaskFeather: { label: 'Miękkość zakresu głębi', min: 0, max: 100 },
