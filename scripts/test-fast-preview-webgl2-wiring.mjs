...
assert.match(panel, /filmLab\.renderDebug\.interactionEngineRow/);
assert.match(panel, /renderDebugInfo\?\.interactionKind/);
assert.match(panel, /filmLab\.renderDebug\.adjustingEngineRow/);
assert.match(panel, /renderDebugInfo\?\.isAdjusting/);
assert.match(panel, /filmLab\.renderDebug\.e2ePanRow/);
assert.match(panel, /renderDebugInfo\?\.e2ePanning/);
assert.match(panel, /filmLab\.renderDebug\.e2eAuxRow/);
...
assert.match(overlays, /filmLab\.pipelineOverlays\.e2eWarnLine/);
assert.match(overlays, /filmLab\.pipelineOverlays\.abDeltaLine/);
assert.match(overlays, /filmLab\.pipelineOverlays\.rolloutHealthLine/);
assert.match(overlays, /filmLab\.pipelineOverlays\.rolloutGateLine/);
assert.match(overlays, /filmLab\.pipelineOverlays\.thresholdsLine/);
...
assert.match(exportDebug, /filmLab\.exportDebug\.thresholdsHintPrefix/);
...
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.readbackParityRgb/);
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /previewE2eKpiState/);
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.e2eFrameCost/);
...
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.healthLegendTitle/);
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.rolloutHealthRowTitle/);
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.rolloutGateRowTitle/);
...
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.workerCpuYield/);
assert.match(read('src/FilmLabRenderDebugPanel.jsx'), /filmLab\.renderDebug\.workerGl3dLut/);
assert.match(panel, /FILMLAB_RECIPE_APPLY_UI_EVENT/);
assert.match(panel, /\.\/filmLab\/recipe\/index\.js/);
assert.match(panel, /aria-live="polite"/);
assert.match(panel, /handleRecipePanelDrop/);
assert.match(panel, /render-debug-panel--recipe-drop/);

assert.match(read('src/filmLabPage.css'), /\.render-debug-panel\.render-debug-panel--recipe-drop\{/);
assert.match(read('src/filmLabPage.css'), /\.shortcut-help-drag-hint\{/);
